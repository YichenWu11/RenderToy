...
float4 PS(VertexOut pin) : SV_Target {
    ...
    diffuseAlbedo *=
        // DownsampleBox4Tap(gTextureMaps[diffuseMapIndex], pin.TexC, float2(1.0f, 1.0f));
    ...
    return float4(ACESToneMapping(litColor.xyz, 1.1), litColor.a);

    float3 rgb_color = litColor.xyz;
    ...
    return float4(rgb_color, litColor.a);
