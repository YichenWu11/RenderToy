...
bool RenderToy::Initialize() {
    ...
    */
    ...
    // FIXME: Only Support Triangle_Face_Model
    ...
    GetRenderRsrcMngr().GetMeshMngr()->BuildOBJModelGeometryFromFile((GetAssetMngr().GetRootPath() / "models/obj/map-bump.obj").string().c_str(), "Plane");
    GetRenderRsrcMngr().GetMeshMngr()->BuildOBJModelGeometryFromFile((GetAssetMngr().GetRootPath() / "models/obj/00.obj").string().c_str(), "TEST");
...
void RenderToy::BuildShaders() {
    ...
    std::filesystem::path shaderPath = GetAssetMngr().GetShaderPath() / "Phong/PhongShading.hlsl";
